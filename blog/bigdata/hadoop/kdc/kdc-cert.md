...
# freeipa cert过期或损坏问题说明
     在低版本的freeipa中有个反人类的设计，就是证书过期后，的有ipa调用功能都不能执行，显示证书过期，2年会自动更新证书,如果没有及时更新成功，那么系统将是毁灭性的灾难。特别是部署在ubuntu系统上，因为freeipa是redHat社区开发维护的，ubuntu系统是移值版本，兼容性很差，高版本已经移除了ubuntu对freeipa的支持。
